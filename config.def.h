...
static const unsigned int gappix    = 10;       /* inner gap pixel between windows */
static const unsigned int gappox    = 10;       /* outer gap pixel between windows and screenframe */
